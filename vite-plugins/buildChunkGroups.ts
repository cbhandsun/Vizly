...
const FLOWCHART_DESIGNER_MICRO_MODULES = new Set([
  ...
  '/src/core/components/diagrams/edgeMutationPolicy.ts',
  '/src/core/components/diagrams/nodeLockPolicy.ts',
  '/src/core/components/shared/diagramControlFit.ts',
  '/src/core/components/shared/diagramControlPaint.ts',
  '/src/core/components/shared/baseReactFlowViewportSemanticContext.ts',
  '/src/core/components/shared/diagramControlRequest.ts',
  '/src/core/components/diagrams/pageCanvasMetadata.ts',
  '/src/core/components/diagrams/NodeUpdateContextValue.ts',
  '/src/core/utils/viewportPersistence.ts',
  '/src/core/components/shared/viewportLogging.ts',
  '/src/core/components/shared/config.ts',
  '/src/core/components/shared/flowStyles.ts',
  '/src/core/components/shared/nodeData.ts',
  '/src/core/components/shared/edgeData.ts',
  '/src/core/components/shared/layoutUtilsLogging.ts',
  '/src/core/components/shared/layoutUtils.ts',
  '/src/core/components/layout/layoutOptimizerLogging.ts',
  '/src/core/components/layout/LayoutDomainSizer.ts',
  '/src/core/components/layout/layoutOptimizerConfig.ts',
  '/src/core/components/layout/LayoutOptimizer.ts',

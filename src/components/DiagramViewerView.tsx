...
import { CommandPalette, DiagramControlBridge } from '@vizly/core/editor-ui';
import type { CommandItem } from '@vizly/core/types';
import type {
    DiagramCollaborationStatus,
    DiagramComponentProps,
    DiagramExportFormat,
} from '@vizly/core/types';
import { DiagramThemeProvider } from '@vizly/core/theme';
import { DiagramLayout } from './layout/DiagramLayout';
import { DeferredEnhancedThemeSelector } from './ui/DeferredEnhancedThemeSelector';
import { ErrorBoundary } from './ui/ErrorBoundary';
import { subscribeMindMapAIConfigRequest } from '@vizly/core/mindmap-runtime';
...
const RoutingDebugPanel = import.meta.env.DEV
    ...
    : null;
const KeyboardShortcutPanel = lazy(() => import('@vizly/core/keyboard-shortcuts').then(module => ({

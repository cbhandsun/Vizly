...
import { THEME_JSON_IMPORT_MAX_BYTES } from '@vizly/core/input';
import { lightThemePreset } from '@vizly/core/theme-presets';
import type { Theme } from '@vizly/core/theme';
...
vi.mock('@vizly/core/theme', async (importOriginal) => ({
  ...await importOriginal<typeof import('@vizly/core/theme')>(),
  useTheme: mocks.useTheme,
}));

vi.mock('@vizly/core/logging', () => ({

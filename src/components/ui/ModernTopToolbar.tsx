...
export const ModernTopToolbar: React.FC<TopToolbarProps> = ({
  ...
  return (
    <div 
        className="flex items-start justify-between w-full mt-4 z-[100] relative box-border transition-all pointer-events-none"
        style={{ 
            paddingLeft: '80px',
    ...
    >
      {/* ── Left Island Group ── */}
      <div className="flex items-center justify-start gap-2 flex-1 min-w-0 overflow-hidden">
      ...
      {/* ── Center Island Group ── */}
      <div className="flex flex-col items-center flex-shrink-0 pointer-events-none gap-2 z-10 px-4">
        <div 
      ...
      {/* ── Right Island Group ── */}
      <div className="flex items-center justify-end gap-2 flex-1 min-w-0 overflow-hidden">

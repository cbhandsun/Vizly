...
import type { DiagramComponentProps, DiagramDefinition } from '@vizly/core/types';
...
export const diagramDefinitions: DiagramDefinition[] = [
  ...
  },
  {
    ...
    component: lazy(() =>
      Promise.all([
        import('@vizly/core/react'),
        import('@vizly/core/plugin-registry'),
        ...
        return {
          default: (props: DiagramComponentProps) =>
            createElement(designerModule.FlowchartDesigner, { ...props, pluginId: 'standard-flow' })
        };
      })
    ),
    category: 'other',
  ...
  ...(import.meta.env.DEV ? ([{
    ...
    component: lazy(() =>
      Promise.all([
        ...
        return {
          default: (props: DiagramComponentProps) =>
            createElement(designerModule.FlowchartDesigner, { ...props, pluginId: 'hello-world' })
        };
      })
    ),
    category: 'other',
  ...
  },
  {
    ...
    component: lazy(() => import('@vizly/core/demo-smart-edge')),
    category: 'debug',
  ...
  },
  {
    id: 'edge-mode-test',
    name: 'Edge Mode Test',
    component: lazy(() => import('@vizly/core/demo-edge-mode')),
    category: 'debug',
  ...
  },
  {
    ...
    component: lazy(() => import('@vizly/core/demo-performance').then(m => ({ default: m.PerformanceDemo }))),
    category: 'debug',

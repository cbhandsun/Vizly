...
describe('display Worker trace recorder', () => {
  ...
  it('aggregates repeated phase work before applying the bounded trace limit', () => {
    ...
    record({
      ...
      changedEdgeCount: 1,
      cacheHitCount: 5,
      processedEdgeCount: 2,
      passCount: 3,
      deduplicatedCandidateCount: 4,
      scalarCandidateCount: 5,
      tinyLaneCandidateCount: 6,
    ...
    record({
      ...
      changedEdgeCount: 2,
      cacheHitCount: 7,
      processedEdgeCount: 5,
      passCount: 6,
      deduplicatedCandidateCount: 7,
      scalarCandidateCount: 8,
      tinyLaneCandidateCount: 9,
    ...
    expect(phaseTrace).toEqual([expect.objectContaining({
      ...
      changedEdgeCount: 3,
      cacheHitCount: 12,
      processedEdgeCount: 7,
      passCount: 9,
      deduplicatedCandidateCount: 11,
      scalarCandidateCount: 13,
      tinyLaneCandidateCount: 15,

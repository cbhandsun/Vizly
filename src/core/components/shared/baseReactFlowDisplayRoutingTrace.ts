export const DISPLAY_ROUTING_PHASE_NAMES = [
  ...
  'quality-crossing-early-closure',
  ...
  'post-render-soft-risk',
  'post-render-soft-obstacle',
...
> = Object.freeze({
  ...
  'quality-crossing-early-closure': 'quality-crossing-global-refine',
  ...
  'post-render-soft-risk': 'post-render-soft-quality',
  'post-render-soft-obstacle': 'post-render-soft-quality',
  ...
  'finalizer-outer-port': 'finalizer',

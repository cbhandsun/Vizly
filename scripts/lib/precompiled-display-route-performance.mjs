...
const projectPhaseTrace = value => {
  ...
  return value.map((trace) => {
    ...
    return {
      ...
      processedEdgeCount: boundedCounter(trace.processedEdgeCount) ?? 0,
      passCount: boundedCounter(trace.passCount) ?? 0,
      deduplicatedCandidateCount: boundedCounter(trace.deduplicatedCandidateCount) ?? 0,
      scalarCandidateCount: boundedCounter(trace.scalarCandidateCount) ?? 0,
      channelCandidateCount: boundedCounter(trace.channelCandidateCount) ?? 0,
      outerLaneCandidateCount: boundedCounter(trace.outerLaneCandidateCount) ?? 0,
      tinyLaneCandidateCount: boundedCounter(trace.tinyLaneCandidateCount) ?? 0,
      obstacleLaneCandidateCount: boundedCounter(trace.obstacleLaneCandidateCount) ?? 0,
      endpointLaneCandidateCount: boundedCounter(trace.endpointLaneCandidateCount) ?? 0,
      endpointOffsetCandidateCount: boundedCounter(trace.endpointOffsetCandidateCount) ?? 0,
      terminalBridgeCandidateCount: boundedCounter(trace.terminalBridgeCandidateCount) ?? 0,
      returnCandidateCount: boundedCounter(trace.returnCandidateCount) ?? 0,
